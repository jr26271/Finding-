...
// TODO: Replace with boost's cppint
...
UINT_X unsigned_max_or(UINT_X a, UINT_X b, UINT_X c, UINT_X d)
{
    ...
    while(cand_bits != 0) {
        ...
        if(alternate_b < a && alternate_d < c) break;
...
{
    return unsigned_max_or(0, unsigned_max_and(a, b, ~d, ~c),
                           0, unsigned_max_and(~b, ~a, c, d));
}
 ...
 * @param b Max value of variable x
 */
UINT_X unsigned_max_not(UINT_X a, UINT_X b)
{
    return ~a;
}
 ...
 * @param b Max value of variable x
 */
UINT_X unsigned_min_not(UINT_X a, UINT_X b)
{
    return ~b;
}
 ...
 * @param d Max value of variable y
 */
UINT_X unsigned_max_left_shift(UINT_X a, UINT_X b, UINT_X c, UINT_X d)
{
    return b << d;
}
 ...
 * @param d Max value of variable y
 */
UINT_X unsigned_min_left_shift(UINT_X a, UINT_X b, UINT_X c, UINT_X d)
{
    return a << c;
}
 ...
 * @param d Max value of variable y
 */
UINT_X unsigned_max_right_shift(UINT_X a, UINT_X b, UINT_X c, UINT_X d)
{
    return b >> c;
}
 ...
 * @param d Max value of variable y
 */
UINT_X unsigned_min_right_shift(UINT_X a, UINT_X b, UINT_X c, UINT_X d)
{
    return a >> d;
}
 ...
 * @param b Max value of variable x
 */
INT_X signed_max_not(INT_X a, INT_X b)
{
    return ~a;
}
 ...
 * @param b Max value of variable x
 */
INT_X signed_min_not(INT_X a, INT_X b)
{
    return ~b;
}
 ...
 * @param d Max value of variable y
 */
INT_X signed_max_left_shift(INT_X a, INT_X b, UINT_X c, UINT_X d)
{
    if(b >= 0)
        return b << d;
    else
 ...
 * @param d Max value of variable y
 */
INT_X signed_min_left_shift(INT_X a, INT_X b, UINT_X c, UINT_X d)
{
    if(a >= 0)
        return a << c;
    else
 ...
 * @param d Max value of variable y
 */
INT_X signed_max_right_shift(INT_X a, INT_X b, UINT_X c, UINT_X d)
{
    if(b >= 0)
        return b >> c;
    else
 ...
 * @param d Max value of variable y
 */
INT_X signed_min_right_shift(INT_X a, INT_X b, UINT_X c, UINT_X d)
{
    if(a >= 0)
        return a >> d;
    else
